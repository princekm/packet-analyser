...
QT_MOC_LITERAL(1, 7, 11), // "sigFinished"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 11), // "sigSnackBar"
QT_MOC_LITERAL(4, 32, 19), // "Worker::MessageType"
QT_MOC_LITERAL(5, 52, 8), // "slotLoad"
QT_MOC_LITERAL(6, 61, 9), // "slotClear"
QT_MOC_LITERAL(7, 71, 7), // "slotLog"
QT_MOC_LITERAL(8, 79, 3), // "row"
QT_MOC_LITERAL(9, 83, 11), // "slotSaveLog"
QT_MOC_LITERAL(10, 95, 8) // "fileName"

    },
    "Logger\0sigFinished\0\0sigSnackBar\0"
    "Worker::MessageType\0slotLoad\0slotClear\0"
    "slotLog\0row\0slotSaveLog\0fileName"
};
...
void Logger::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->sigSnackBar((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< Worker::MessageType(*)>(_a[2]))); break;
        case 2: _t->slotLoad(); break;
        case 3: _t->slotClear(); break;
        case 4: _t->slotLog((*reinterpret_cast< QStringList(*)>(_a[1]))); break;
        case 5: _t->slotSaveLog((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Logger::sigFinished)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Logger::*)(QString , Worker::MessageType );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Logger::sigSnackBar)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Logger::sigFinished()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void Logger::sigSnackBar(QString _t1, Worker::MessageType _t2)
{
