...
QT_MOC_LITERAL(1, 13, 7), // "sigNext"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 12), // "slotProgress"
QT_MOC_LITERAL(4, 35, 10) // "percentage"

    },
    "SplashScreen\0sigNext\0\0slotProgress\0"
    "percentage"
};
...
void SplashScreen::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sigNext(); break;
        case 1: _t->slotProgress((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SplashScreen::sigNext)) {
                *result = 0;
                return;
            }
        }
